...
@PageUrl("/login")
public class LoginPage extends OperationAopPage {
	@FindBy(id = "username")
	...
	public LoginPage usernameTextIn(String text) {
		operation.handlerWrite(usernameInput, text);
		return this;
	}

	public LoginPage passwordTextIn(String text) {
		operation.handlerWrite(passwordInput, text);
		return this;
	}

	public MainPage loginButton() {
		operation.handlerClick(loginButton);
		return mainPage;
	}
